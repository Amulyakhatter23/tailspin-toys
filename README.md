...
The homepage includes category and publisher filters. Categories support multiple selections, and the filters can be combined; filtering happens in the browser over the statically generated game cards.
